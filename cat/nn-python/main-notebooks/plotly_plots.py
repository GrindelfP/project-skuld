...
def plot_surface(
    ...
    **func_kwargs,
    ...
    """
    Generates a 3D surface plot of a given 2D function.

    Args:
        func: The 2D function to plot. It should take a tensor of shape (N, 2)
    ...
    Returns:
        A Plotly Figure object containing the 3D surface plot.
    """
...
def plot_line(
    ...
    **func_kwargs: Any,
    ...
    """
    Creates a 1D function plot using Plotly.
