...
class MLP(nn.Module):
    ...
    def __init__(self, input_size: int, hidden_size: int) -> None:
        """
            Main constructor.
            :param input_size: input layer size (number of integrand
            dimensions)
            :param hidden_size: hidden layer size (arbitrary value,
    ...
    def fit(
        ...
        for epoch in range(epochs):
            ...
            self.optimizer.step()  # optimization step (network params are
            # being updated)
            loss_history.append(loss.item())  # current loss function
            # added to history
...
class NeuralNumericalIntegration:
    ...
    def calculate2(
        ...
        """
            ...
            :param alphas:         lower boundaries sequence
    ...
    def integrate(
        ...
        """
            ...
            :param alphas: lower boundaries sequence (should be placed in
                                                            integration order)
            :param betas:  upper boundaries sequence (should be placed in
                                                            integration order)
...
def generate_data(
    ...
    """
        ...
        function and neural
        network input as well as the function values for the generated
        tensor of variables.
...
def generate_data_uniform(
    ...
    """
        ...
        of variables
        for the function and neural network input as well as the function
        values for
