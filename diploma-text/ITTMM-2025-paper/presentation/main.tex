...
\author{Gregory A. Shipunov, student of gr. 4181\inst{1} \\ Oksana I. Streltsova, thesis supervisor\inst{1, 2} \\ Yury L. Kalinovsky, thesis consultant\inst{1, 2}}
\institute{
...
\newcommand{\logoBottomLeft}[1]{
    \begin{tikzpicture}[remember picture,overlay]
        \node[anchor=south west, inner sep=10pt, xshift=-0.5cm] at (current page.south west) {\includegraphics[width=3.5cm]{#1}};
    \end{tikzpicture}
}
...
This work is dedicated to developing the software for numerical calculations in domain of modelling of physical processes for NICA collider. Numericall modelling of physical processes involves studying of particles’ properties based on Bethe-Salpeter equation.
